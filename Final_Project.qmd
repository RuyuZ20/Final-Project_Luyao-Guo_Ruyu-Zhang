...
(Partner 1): 
Handle placeholder values and clean the data.
Identify and replace placeholder values like 9999999 with NaN.
Filter the dataset for individuals aged 65+.
Create a new column for Housing_Burden (e.g., RENTGRS / INCTOT * 100).
Deliverables:
...
Calculate descriptive statistics for key variables (AGE, INCTOT, RENTGRS, etc.).
Group data by STATEFIP and calculate average housing burden for older adults.
Deliverables:
Summary statistics.
